...
<p align="center">
  <a href="mailto:ricksond2003@gmail.com">
    <img src="https://img.shields.io/badge/Email-ricksond2003%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"/>
  </a>
...
> **"How hard can working with data really be?"**

Then came joins, null values, schema mismatches, failed pipelines, dependency conflicts, and Docker containers that somehow work perfectly until you need to demo them.

So naturally, I decided to learn more.

I'm currently pursuing an **M.S. in Data Science at Virginia Commonwealth University**, where my interests have evolved from analyzing data to building the systems that make data and machine learning useful in the real world.

Today, my focus sits at the intersection of:

**Data Engineering → Machine Learning → AI Engineering**

I enjoy taking projects from **raw data to reliable, automated solutions** — designing pipelines, transforming and modeling data, training predictive models, orchestrating workflows, and building the infrastructure needed to make those systems repeatable.
...
Building reliable data systems and pipelines involving:
...
Developing and evaluating predictive systems using:
...
Expanding my ability to take data and ML systems beyond the notebook using:
...
<p>
  <img src="https://skillicons.dev/icons?i=python,java,js,mysql,postgres" alt="Programming technologies"/>
</p>
...
<p>
  <img src="https://skillicons.dev/icons?i=docker,kubernetes,terraform" alt="Data engineering technologies"/>
</p>

`Databricks` `Delta Lake` `dbt` `Apache Airflow` `PostgreSQL` `Docker` `Kubernetes` `Terraform`

### Machine Learning & AI

`Scikit-learn` `PyTorch` `TensorFlow`

`Classification` `Regression` `Feature Engineering` `Cross-Validation` `Hyperparameter Tuning`

### Cloud & DevOps

<p>
  <img src="https://skillicons.dev/icons?i=aws,git,github,githubactions" alt="Cloud and DevOps technologies"/>
</p>

`AWS` `EC2` `S3` `Lambda` `Glue/DataBrew` `Git` `GitHub Actions`
...
**Langley Federal Credit Union** · June 2026 – August 2026

Worked on an enterprise machine learning initiative spanning data preparation, exploratory analysis, predictive modeling, production deployment, and business reporting.

* Prepared enterprise data warehouse datasets using **SQL and Python** for machine learning applications.
* Developed and evaluated **five classification models** using cross-validation and hyperparameter tuning.
* Achieved **94% accuracy and a 0.96 F1-score**, with XGBoost selected for production development.
